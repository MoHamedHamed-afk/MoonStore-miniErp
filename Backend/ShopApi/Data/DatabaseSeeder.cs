    ...
    private static IEnumerable<Product> CreateFallbackProducts()
    {
        ...
        return new[]
        {
            new Product
            {
                ...
                ImageUrlsCsv = "assets/images/moon-look-pink-set.png",
                Category = "Winter",
                StockQuantity = 18,
                SizesCsv = "S,M,L,XL",
            ...
            new Product
            {
                ...
                ImageUrlsCsv = "assets/images/moon-look-charcoal-set.png",
                Category = "Winter",
                StockQuantity = 16,
                SizesCsv = "S,M,L,XL",
            ...
            new Product
            {
                ...
                ImageUrlsCsv = "assets/images/moon-look-burgundy-set.png",
                Category = "Winter",
                StockQuantity = 14,
                SizesCsv = "S,M,L,XL",
            ...
            new Product
            {
                ...
                ImageUrlsCsv = "assets/images/moon-look-pink-hoodie.png",
                Category = "Summer",
                StockQuantity = 20,
                SizesCsv = "S,M,L,XL",
                ColorsCsv = "Pink,Blue",
            ...
            new Product
            {
                ...
                ImageUrlsCsv = "assets/images/moon-look-cream-set.png",
                Category = "Summer",
                StockQuantity = 17,
                SizesCsv = "S,M,L,XL",
            ...
            new Product
            {
                ...
                ImageUrlsCsv = "assets/images/moon-look-layered-lounge.png",
                Category = "Summer",
                StockQuantity = 15,
                SizesCsv = "S,M,L,XL",
